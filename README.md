...
* Runtime: **Info Line Position Slider** — drag the header info line (temp/humidity/badges) left, center, or right with a slider that snaps at 0 / 50 / 100. Closes [#47](https://github.com/lop1505/RoomCard/issues/47).
